...
Configuration necessaire pour le deploiement:
...
Le deploiement est gere directement via circle ci , le fichier de configuration " config.yml " , Ce dernier s'active quand vous faites un push dans votre code.
